...
| `web/src` | 4 | The React app shell: mounts the root component, wires the live WebSocket or static-replay data source into race state, and lays out the dashboard panels. |
| `web/src/components` | 30 | The dashboard's presentational components — map, timing tower, standings, telemetry, comms, race control, ghost/compare overlays, and their shared layout/formatting helpers. |
...
17 source directories, 110 files, 0 without a declared purpose.
